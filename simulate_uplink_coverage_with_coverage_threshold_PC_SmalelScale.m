function Pcov = simulate_uplink_coverage_with_coverage_threshold_PC_SmalelScale(params)
...
for m = 1:params.space_realizations;
    ...
    for t = 1:params.time_slots
        ...
        server_m2m_P = params.Pmin * exprnd(1,size(distance_to_server)) .* exp(params.SEPL.alpha .* distance_to_server .^ params.SEPL.beta);
